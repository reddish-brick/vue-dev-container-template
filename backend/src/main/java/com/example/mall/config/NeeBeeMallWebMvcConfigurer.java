...
import com.example.mall.config.handler.TokenToAdminUserMethodArgumentResolver;
import com.example.mall.config.handler.TokenToMallUserMethodArgumentResolver;
