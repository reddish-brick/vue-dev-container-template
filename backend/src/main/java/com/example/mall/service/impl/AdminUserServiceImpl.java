...
import com.example.mall.dao.AdminUserMapper;
import com.example.mall.dao.NewBeeAdminUserTokenMapper;
...
//      String token = getNewToken(System.currentTimeMillis() + "", loginAdminUser.getAdminUserId());
      return String.format("%s %s %s %s", System.currentTimeMillis(), loginAdminUser.getAdminUserId(),
          loginAdminUser.getLoginUserName(), loginAdminUser.getLoginPassword());
    }
